    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto_perfil', models.ImageField(blank=True, null=True, upload_to='fotos_perfil', verbose_name='Foto Perfil')),
                ('condicion', models.CharField(choices=[('Habilitado', 'Habilitado'), ('Suspendido', 'Suspendido'), ('Bloqueado', 'Bloqueado')], default='Habilitado', max_length=20, verbose_name='Condición')),
                ...
                ('rol', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='auth.group', verbose_name='Rol')),
